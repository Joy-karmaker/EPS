                        ...
                        <div class="card my-2 ">
                            <div class="card-body" style="text-align: center">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-4">
                                    <input id="phone_no" type="tel" class="form-control" value="{{ old('phone_no') }}"  placeholder="Phone Number"><span id="valid-msg" class="hide"></span><span id="error-msg" class="hide"></span>
                                    </div>
                                </div>
