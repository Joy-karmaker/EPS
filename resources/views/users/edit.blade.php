...
<head>
    ...
    {{-- <link id="pagestyle" href="../user/css/material-dashboard.css?v=3.1.0" rel="stylesheet" /> --}}
    {{-- <link href="{{ asset('/')}}/user/bootstrap/css/bootstrap.min.css" rel="stylesheet" /> --}}
    {{-- <link href="../user/bootstrap/css/bootstrap.min.css"> --}}
       {{-- <link id="pagestyle" href="../user/bootstrap/css/bootstrap.min.css" rel="stylesheet" /> --}}
</head>
                    ...
                    <div class="card my-2 ">
                        <div class="card-body" style="text-align: center">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-4">
                                    <input id="phone_no" type="tel" class="form-control" value="{{ $user->phone_no}}"  placeholder="Phone Number"><span id="valid-msg" class="hide"></span><span id="error-msg" class="hide"></span>
                                    </div>
                            </div>
                            ...
                            <div >
                                @if ($user->image!='')
                                <img src="/Image/{{ $user->image }}" alt="profile_image" height="10px" width="30px">
